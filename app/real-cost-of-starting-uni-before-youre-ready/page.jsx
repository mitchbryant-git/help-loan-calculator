    ...
    <div className="guide-article-page min-h-screen pb-20">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 relative z-10 app-fade-in">
        <GuidePageIntro
          code="05"
          accent="pink"
          title="The Real Cost of Starting Uni Before You're Ready"
          summary="Compare the financial consequences of switching degrees, leaving early, or taking time before enrolling—without pretending there is one correct path for everyone."
        />
