...
- **Meta Description:** Learn how HECS-HELP indexation works in Australia. See historical rates, the CPI/WPI cap reform, and why "your debt won't outgrow your wages" isn't the full story.
- **Slug:** /guides/how-hecs-indexation-works
...
The Wage Price Index is calculated by the [Australian Bureau of Statistics](https://www.abs.gov.au/statistics/economy/price-indexes-and-inflation/wage-price-index-australia/latest-release). The ABS surveys around 3,000 businesses across Australia and tracks price changes for approximately 20,000 individual jobs each quarter. The WPI measures the average change in the price of labour across the entire economy, covering both private and public sectors, across all industries and all states.
...
*Source: [Australian Taxation Office](https://www.ato.gov.au/tax-rates-and-codes/study-and-training-support-loans-indexation-rates)*
...
Indexation rates are published by the [Australian Taxation Office](https://www.ato.gov.au/tax-rates-and-codes/study-and-training-support-loans-indexation-rates). Information on the CPI/WPI cap is from the [Department of Education](https://www.education.gov.au/helpestimator) and [Study Assist](https://www.studyassist.gov.au/managing-and-repaying-your-loan/loan-increases-and-indexation). WPI methodology and data are published by the [Australian Bureau of Statistics](https://www.abs.gov.au/statistics/economy/price-indexes-and-inflation/wage-price-index-australia/latest-release).
