...
export default function PrimaryResult({
  ...
  return (
    <section
      className="primary-result mb-colour-card overflow-hidden rounded-[28px] border border-black/15"
    ...
    >
      <div className="primary-result__main p-5 sm:p-6">
        ...
        <h2
          ...
          className="primary-result__value mt-1.5 font-anybody text-[clamp(3.25rem,6vw,5rem)] font-extrabold leading-[0.88] tracking-[-0.065em] text-[var(--mb-ink)]"
        >
          {isDebtFree ? `${years} years` : '50+ years'}
        </h2>

        {isDebtFree ? (
          <p className="primary-result__description mt-4 max-w-xl font-instrument text-sm leading-relaxed text-[var(--mb-muted)]">
          ...
          <div className="primary-result__description mt-4 flex max-w-xl items-start gap-3 rounded-2xl border border-[var(--mb-pink)]/30 bg-[var(--mb-pink)]/8 p-3 text-[var(--mb-ink)]">
      ...
      <div className="primary-result__readouts grid grid-cols-2 gap-px bg-white/10 p-px">
        <div className="primary-result__metric bg-[var(--mb-readout)] p-4 text-white sm:px-5">
        ...
        <div className="primary-result__notice col-span-2 flex items-center gap-3 bg-[var(--mb-readout)] px-4 py-3 text-white/70 sm:px-5">
